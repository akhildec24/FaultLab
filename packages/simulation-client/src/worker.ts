...
async function ensureLoaded(): Promise<void> {
  ...
  // The WASM file is generated by `just wasm-pack` and placed at
  // apps/web/src/wasm/simulation_wasm.js. A stub exists for dev.
  // The @faultlab/wasm alias is resolved by Vite.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const mod = (await import('@faultlab/wasm')) as any as WasmModule
  wasmModule = mod
