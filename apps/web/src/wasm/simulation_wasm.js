/* @ts-self-types="./simulation_wasm.d.ts" */
...
export class Simulation {
     ...
     */
    current_time() {
        const ret = wasm.simulation_current_time(this.__wbg_ptr);
    ...
    get_metrics() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulation_get_metrics(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_recent_events() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulation_get_recent_events(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulation_get_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    inject_failure(json) {
        ...
        const ret = wasm.simulation_inject_failure(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    is_running() {
        const ret = wasm.simulation_is_running(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    load_scenario(json) {
        const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simulation_load_scenario(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pause() {
        wasm.simulation_pause(this.__wbg_ptr);
    }
    /**
     ...
     */
    pending_events() {
        const ret = wasm.simulation_pending_events(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    run(max_steps) {
        const ret = wasm.simulation_run(this.__wbg_ptr, max_steps);
        return ret >>> 0;
    }
    /**
     ...
     */
    start() {
        wasm.simulation_start(this.__wbg_ptr);
    }
    /**
